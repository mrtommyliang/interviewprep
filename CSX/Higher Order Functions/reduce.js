...
Here's how it works:
  ...
  In the example above, the accumulator begins at 0. add(0, 4) is called.The accumulator's value is now Then add(4, 1) makes it 5. Finally add(5, 3) brings it to 8, which is returned.
